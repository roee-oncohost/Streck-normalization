...
def msnCal_norm(RFU_hyb, somamers, sampl, dil_lab=("0", "0_005", "0_5", "20")):
    ...
    for sampl_type in ['Calibrator']: # Only calibrators according to the paper
...
adat_path = r"C:\Users\GilLoewenthal\Oncohost DX\Shares - Gil Loewenthal\code\sl_normalization\241027 Flag Pass check\014\OH2024_014.adat"
